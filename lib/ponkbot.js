...
class PonkBot extends EventEmitter {
    constructor(config){
        ...
        Object.assign(this, {
            ...
            playlistLength : -1, //Length of playlist??????????????????????
    ...
    registerListeners(socket){
        ...
        //I added this
        socket.on('errorMsg', data => console.log('errorMsg', data))
        socket.on('kick', data => console.log('kick', data))
        socket.on('loadFail', data => console.log('loadFail', data))
        socket.on('needPassword', data => console.log('needPassword', data))
        socket.on('noflood', data => console.log('noflood', data))
        socket.on('pm', data => console.log('pm', data))
        /*
