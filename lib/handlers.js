...
module.exports = {
    ...
    handleDisconnection: function(reason){
        ...
        const reconnect = ()=>{
            ...
            // Retry
//            this.client.socket.once('reconnect_error', ()=>{
//            	console.log("### Reconnect error.");
//                setTimeout(()=>{
//                    reconnect();
//                }, 10000)
//            });
//            this.client.socket.once('reconnect_failed', ()=>{
//            	console.log("### Reconnect failed.");
//            	setTimeout(()=>{
//            		reconnect();
//            	}, 10000)
//            });
//            this.client.socket.once('connect_error', ()=>{
//            	console.log("### Connect Error.");
//            	setTimeout(()=>{
//            		reconnect();
//            	}, 10000)
//            });
            this.client.socket.once('connect_timeout', ()=>{
        ...
        this.client.once('connected', ()=>{
        	console.log("###Reconnect Attempt Connected ... starting!" );
...
//        this.logger.log(`The channel now has ${count} users connected.`);
    ...
    */
    ...
    handlePlaylistMeta: function({ count, rawTime, time}){
    	this.playlistLength = rawTime;
    	this.logger.log(`The raw time is ${rawTime}`);
    ...
    */
    ...
    handleVideoUpdate: function({ currentTime, paused }){
        ...
        var a = this.currMedia.duration.split(':'); // split it at the colons
        // minutes are worth 60 seconds. Hours are worth 60 minutes.
        
        this.logger.log('a is length' + a.length);
        if(a.length === 2){
        ...
        var potentialScrobble = this.currMedia.type + this.currMedia.id;
        this.logger.log('potential scrobble ' + potentialScrobble);
        this.logger.log('lastScrobbled ' + lastScrobbled);
        
        if (currentTime > 30 && currentTime > seconds * 0.5 && lastScrobbled != potentialScrobble) {
        	this.logger.debug('This would have scrobbled ', this.currMedia.type, this.currMedia.id);
        	lastScrobbled = potentialScrobble;
        	var typeToScrobble = this.currMedia.type;
        	var idToScrobble = this.currMedia.id;
        	this.logger.log('typetoScrobble' + typeToScrobble);
        	this.logger.log('idToScrobble' + idToScrobble);
